package com.mutualfunds.api.mutual_fund.shared.security.oauth2;

import com.mutualfunds.api.mutual_fund.features.users.domain.User;
import com.mutualfunds.api.mutual_fund.features.users.domain.AuthProvider;
...
public class OAuth2LoginSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    private User processOAuthUser(String email, String name) {
        Optional<User> existingUser = userAccountService.findByEmail(email);
        ...
        User savedUser = userAccountService.save(newUser);
