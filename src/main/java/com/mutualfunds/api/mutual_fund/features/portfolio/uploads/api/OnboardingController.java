...
import com.mutualfunds.api.mutual_fund.features.portfolio.uploads.dto.response.UploadResponse;
import com.mutualfunds.api.mutual_fund.features.risk.api.IRiskProfilingService;
import com.mutualfunds.api.mutual_fund.features.risk.application.RiskRecommendationService;
...
public class OnboardingController {
    ...
    public ResponseEntity<UploadResponse> getUploadStatus(@PathVariable UUID uploadId) {
        ...
        if (!upload.getUser().getUserId().equals(currentUser.getUserId())) {
            ...
            throw new com.mutualfunds.api.mutual_fund.shared.exception.ForbiddenException(
